public static class DbInitializer
{
    ...
    {
        await CreateUserAsync(userManager, "Admin Adminli", "admin_ecobony", "admin@ecobony.com", "Admin123!", RoleModel.Admin);
        await CreateUserAsync(userManager, "Manager Managerli", "manager_ecobony", "manager@ecobony.com", "Manager123!", RoleModel.Manager);
    }
